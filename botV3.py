...
TOKEN = 'BOT TOKEN' #GET YOUR TOKEN ON BOTFATHER
...
def handle_start(message):
    ...
    bot.send_message(user_id, "Welcome to CodeBreakers Bot!\n\nYou can use the following commands:\n"
                              "/nmap - Start an Nmap scan.\n"
                              "/dirbuster - Start a directory brute-force scan.\n"
                              "/login - Log in to your Instagram account.\n"
                              "/getinfo - Retrieve public user information from Instagram.\n"
                              "/search - Search for a username across social media platforms.\n"
                              "/wpscan - Perform a WordPress vulnerability scan.\n"
                              "/searchsploit - Search for exploits using Exploit-DB.\n"
                              "/rdp - Use cybersecurity tools (Masscan or Metasploit).")
...
def handle_getinfo(message):
    ...
    try:
        ...
        if 'INSTAGRAM_USERNAME' not in globals() or 'INSTAGRAM_PASSWORD' not in globals():
            bot.send_message(user_id, "Instagram credentials are not provided. Please use /login to provide your Instagram credentials first.")
            return
        ...
        bot.send_message(user_id, "Please provide a username. Usage: /getinfo <username>")
